...
For fun, let's see the connection between Brownian Motion and its connection to
the heat equation. This profound connection was discovered by none other than
Albert Einstein in 1905 when he was 26 and working on Special Relativity and the
Photoelectric Effect :). Let's first define the Heat Equation:
$$
